angular.module('theme.core.main_controller', ['theme.core.services', 'angularRestfulAuth'])
  .controller('MainController', ['$scope', '$theme', '$timeout', 'progressLoader', '$location', '$localStorage', 'authServ',
    function($scope, $theme, $timeout, progressLoader, $location, $localStorage, authServ) {
    'use strict';
