angular
  .module('theme.core.navigation_controller', ['theme.core.services', 'angularRestfulAuth'])
  .controller('NavigationController', ['$scope', '$location', '$timeout', function($scope, $location, $timeout) {
    'use strict';
        $scope.menu = [{
            ...
            label: 'Analisi Centrale Rischi',
            iconClasses: 'glyphicon glyphicon-list-alt',
            url: '#/documents?filter=Analisi Centrale Rischi'
        },{
            label: 'Analisi Di Bilancio',
            iconClasses: 'glyphicon glyphicon-list-alt',
            url: '#/documents?filter=Analisi Di Bilancio'
        },{
            label: 'Analisi Cond. Bancarie',
            iconClasses: 'glyphicon glyphicon-list-alt',
            url: '#/documents?filter=Analisi Condizioni Bancarie'
        },{
            label: 'Servizio CashFlow',
